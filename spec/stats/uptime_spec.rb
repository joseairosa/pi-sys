...
describe PiSys::Uptime do
  ...
  it 'should support respond to time' do
    expect(subject[:time]).to eq '23:34:05'
  end
  it 'should support respond to up' do
    expect(subject[:up]).to eq '1 day, 52 min'
  end
  it 'should support respond to users' do
    expect(subject[:users]).to eq '1'
  end
  it 'should support respond to load_average' do
